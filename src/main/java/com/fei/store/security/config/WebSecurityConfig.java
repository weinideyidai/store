...
import com.fei.store.security.JwtAuthenticationTokenFilter;
import com.fei.store.security.JwtTokenUtil;
import com.fei.store.security.domain.JwtAuthenticationEntryPoint;
import com.fei.store.security.service.JwtUserService;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  protected void configure(HttpSecurity httpSecurity) throws Exception {
    httpSecurity
        ...
        .authorizeRequests()
        .antMatchers("/auth/**","/webjars/**","/chat/**","/user/phoneCode/**","/user/updatePassword/**","/**").permitAll()
